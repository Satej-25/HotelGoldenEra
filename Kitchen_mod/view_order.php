            ...
            <div class="navbar-header">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/bookingSystem/user-gelogo2.png" alt="user" class="profile-pic" /></a>
                            ...
                            <div class="card-header">
                                ...
                                <div class="table-responsive m-t-20">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                           <?php
											$sql="SELECT table_number.*, users_orders.* FROM table_number INNER JOIN users_orders ON table_number.t_no=users_orders.table_no where o_id='".$_GET['user_upd']."'";
											...
											<tr>
												    ...
												    <td><center><?php echo $rows['table_no']; ?></center></td>
													   <td><center>
