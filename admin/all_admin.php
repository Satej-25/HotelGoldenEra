                                ...
                                <div class="table-responsive m-t-40">
                                    ...
                                    <thead class="thead-dark">
                                        ...
                                        <tbody>
											...
											<?php
												$sql="SELECT * FROM admin order by adm_id asc";
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td>'.$rows['username'].'</td>
																								...
																								<td>'.$rows['date'].'</td>
																									 <td><a href="delete_admin.php?admin_del='.$rows['adm_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_admin.php?admin_upd='.$rows['adm_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';
																		}	
														}
											?>
